...
object UnityRunUtil {
    ...
    fun isUnityEditorProcess(processInfo: ProcessInfo): Boolean {
        ...
        return (name.equals("Unity", true) || name.equals("Unity Editor", true) || name.equals("Tuanjie", true)
            || canonicalName.equals("unity", true) || canonicalName.equals("Unity Editor", true) || canonicalName.equals("Tuanjie", true))
    }
